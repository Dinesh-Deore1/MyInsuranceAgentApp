...
<title>Insurance Agent App - Admin Login</title>
<!-- Bootstrap CSS -->
<link rel="stylesheet"
	...
	<nav class="navbar navbar-expand-lg navbar-dark">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link" href="agent">Agent</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="policyHolder">Policy
						Holder</a></li>
			</ul>
		</div>
	</nav>
