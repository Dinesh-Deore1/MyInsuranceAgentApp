...
<title>Insurance Agent App - View NearBy Policy</title>
<!-- Bootstrap CSS -->
<link rel="stylesheet"
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="active" href="viewNearByPolicy">View nearBy expiry Policies</a>
                ...
                <tbody>
                    ...
                    <%
                        ...
                        for (PolicyTable p : policyList) {
                            ...
                            // Check if the due date is within the next month
                            if (dueDate.after(new Date()) && dueDate.before(oneMonthFromNow)) {
                    %>
                        <tr>
                            ...
                            <td style="color: green;font-weight: bold;"><%=p.getDueDate()%></td>
                        </tr>
                    <% 
                            }
                        }
