...
<body>
    ...
    <!-- Agent Table (Display only Pending Agents) -->
        ...
        <div class="agent-table">
            <table>
                ...
                <tbody>
                    ...
                    <%
                        List<Agent> agentList = (List<Agent>) request.getAttribute("agentList");
                    ...
                    %>
                                <tr>
                                    ...
                                    <td><%=a.getStatus()%></td>
                                    <td>
	                                    <a href="approve/<%= a.getAgentId()%>?action=approve" class="btn btn-success">Approve</a>
	                                    <a href="disapprove/<%= a.getAgentId()%>?action=disapprove" class="btn btn-danger">Disapprove</a>
                                    </td>
                                </tr>
                    <%
                            }                                            
