...
<head>
    ...
    <title>Insurance Agent App - Agent Login</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="login-form">
                    ...
                    <p class="register-link">Don't have an account? <a href="agentRegister" class="text-info">Click here to register</a>.</p>
                </div>
            </div>
        </div>
    </div>
