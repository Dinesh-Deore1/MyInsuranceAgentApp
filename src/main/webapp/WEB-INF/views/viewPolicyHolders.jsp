...
<title>Insurance Agent App - view policy Holders</title>
<!-- Bootstrap CSS -->
<link rel="stylesheet"
...
<body>
    ...
    <div class="sidebar">
        ...
        <a class="active" href="viewAllPolicyHolders">View Policy Holders</a>
		...
		<div class="agent-table">
			<table>
				...
				<tbody>
					...
					<%
					List<PolicyHolder> policyHolder = (List<PolicyHolder>) request.getAttribute("policyHolderList");

					for (PolicyHolder p : policyHolder) {
					%>
					<tr>
						...
						<td><%=p.getEmail()%></td>
						<td>
							<a href="delete/<%= p.getpId()%>?action=delete" class="btn btn-danger">Delete</a>
						</td>
					</tr>
					<%
					}
